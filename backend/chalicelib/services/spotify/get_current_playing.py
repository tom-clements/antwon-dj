...
@use_spotify_session
def spotify_currently_playing_uncached(
...
def is_currently_playing_a_song(currently_playing: Optional[SpotifyCurrentlyPlaying]) -> bool:
...
def get_placeholder_empty_song() -> SpotifyTrackFormatted:
