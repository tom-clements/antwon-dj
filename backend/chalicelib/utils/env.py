...
COGNITO_POOL_NAME: Final[str] = str(os.getenv("COGNITO_POOL_NAME"))
COGNITO_POOL_ARN: Final[str] = str(os.getenv("COGNITO_POOL_ARN"))
LOGIN_REDIRECT_ENDPOINT: Final[str] = str("login/callback")
LOGOUT_REDIRECT_ENDPOINT: Final[str] = str("logout/callback")
SPOTIFY_REDIRECT_ENDPOINT: Final[str] = str("user/spotify/callback")
